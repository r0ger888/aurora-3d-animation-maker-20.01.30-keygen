...
ScrollText	    		db	"PERYFERiAH tEAM present an MD5 keygen for Aurora 3D Animation Maker 20.01.30                                               "
						db  "Keygenned by GRUiA                                                             "
						db  "GreetZ 2 all of the PRF members including Al0hA,r0ger,B@TRyNU,sabYn,"
						...
						db  "ies ! :3)                                                           "
						db  "Look for more details either on PRF.nfo or .... idfk , just email us"
						db  " or even contact us through discord ffs .. :E                     ",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,9
		mov scr.scroll_y,238
		
		mov scr.scroll_width,340
